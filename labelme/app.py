...
=======
    def selectCursorArrow(self):
        ...
        self.canvas.positionY = 0

    def selectCursorTarget1(self):
        self.canvas.newcursor = os.getcwd() + "/icons/cursorTarget1.png"
        self.canvas.positionX = -1
        self.canvas.positionY = -1

    def selectCursorTarget2(self):
        self.canvas.newcursor = os.getcwd() + "/icons/cursorTarget2.png"
        self.canvas.positionX = -1
        self.canvas.positionY = -1
